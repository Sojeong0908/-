...
const initialState = [
  { id: 1, name: "sojeong0908", email: "thwjd0908@gmail.com", active: true },
  { id: 2, name: "thwjd_123", email: "thwjd_123@naver.com", active: false },
...
function Users() {
  ...
  // useMemo : 디펜던시에 있는 값이 변했을 때만 연산한다.
  ...
  const handleSubmit = useCallback(() => {
    ...
    setUserList(initialInputs);
  }, [userList, name, email]);

  // useCallBack : 디펜던시에 있는 값이 변했을 때에만 함수를 재생성. 즉, 성능개선.
