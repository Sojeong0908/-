//JS는 함수에 정의된 매개변수보다 전달된 인자가 많아도 오류가 발생하지 않는다.
...
function sumTotal() {
  //arguments : 전달된 모든 인자를 유사배열 형태로 담는다.
...
// rest 문법 => 매개변수 앞에 ...을 붙이면 전달된 매개변수를 모두 배열로 모아준다.
...
let copy02 = { ...obj }; // {name: "seok", age : 31}
copy02.age = 31;
copy02.foo.bar = "변경";
